...
class UserSubscriptionMap(Base):
    ...
    subscription_name = Column(ForeignKey("subscriptions.name"), ondelete="CASCADE", primary_key=True, nullable=False)
    user_email = Column(ForeignKey("users.email"), ondelete="CASCADE", primary_key=True, nullable=False)
